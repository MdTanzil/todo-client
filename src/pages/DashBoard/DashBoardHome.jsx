...
const DashBoardHome = () => {
  ...
  const selectedIndex = useOutletContext();
  ...
  return (
    <div className="min-w-full mx-auto ">
      <Tabs  selectedIndex= {selectedIndex}>
        ...
        <Tab onClick={() => setSelectedStatus('To-Do')}>To-Do</Tab>
          <Tab onClick={() => setSelectedStatus('Ongoing')}>Ongoing</Tab>
          <Tab onClick={() => setSelectedStatus('Completed')}>Completed</Tab>
        </TabList>
